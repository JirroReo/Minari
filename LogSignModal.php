                                     ...
                                     <div class="panel-body">
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                          <p>Note</p>
                                            Password must be atleast 8 to 15 characters. Only letters, numeric digits, underscore and first character must be a letter.
                                         </div> 
                                        </div>
                                      </div> 
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITIONS</b></a> of Minari.</small>
