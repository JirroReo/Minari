          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                ...
                <li><a href="#"><i class="fa fa-envelope"></i> riyujiro@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 clearfix">
            ...
            <!--<a href="<?php echo web_root?>">Minari</a>-->
            </div> 
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2>Minari</h2>
              <p>Where traditional Japanese techniques perfection meets modern day ingredients and technology</p>
            </div>
          </div>
          <!--<div class="col-sm-7">
            <div class="col-sm-6">
